        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
            <div class="card custom-card">
                ...
                <div class="mr-auto float-right">
                    <a href="http://127.0.0.1:8000/admin/imdb/create" class="btn btn-info"> <i
                            class="fa fa-arrow-right mx-2"></i>برگشت به
                        ایجاد</a>
                </div>
                <form action="{{ route('imdb.selectedDel') }}" method="post">
                    @csrf
                                    ...
                                    @foreach ($data as $key => $d)
                                        <tr>
                                            ...
                                            <a href="./articleDetails.html" class="btn btn-sm btn-success">
                                                ...
                                                <a href="{{ route('imdb.edit', $d->id) }}" class="btn btn-sm btn-info"
                                                    title="ویرایش">
                                                    <i class="fe fe-edit-2"></i>
                                                </a>
                                                <form method="post" action="{{ route('imdb.destroy', $d->id) }}">
                                                    @method('delete')
                                                    @csrf
