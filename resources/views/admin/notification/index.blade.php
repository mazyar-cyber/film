        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
            <div class="card custom-card">
                ...
                <div class="mr-auto float-right">
                    <a href="http://127.0.0.1:8000/admin/notofication/create" class="btn btn-info"> <i
                            class="fa fa-arrow-right mx-2"></i>برگشت به
                        ایجاد</a>
                </div>
                <form action="{{ route('notofication.selectedDel') }}" method="post">
                    @csrf
                    @method('delete')
                                ...
                                <tbody>
                                    @foreach ($data as $key => $d)
                                        <tr>
                                            ...
                                            {{-- <form method="post" action="{{ route('notofication.destroy', $d->id) }}">
                                                    @method('delete')
                                                    @csrf
