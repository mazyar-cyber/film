...
<head>
    ...
    <meta name="author" content="mazyar ghahremani,mazyarmg7731@gmail.com" />
    <meta name="keywords"
        ...
        <div class="main-sidebar main-sidebar-sticky side-menu">
            <div class="sidemenu-logo">
                <a class="main-logo" href="index.html">
                    <img src="/assets/img/brand/logo.png" class="we-logo" height="50px " alt="لوگو" />
                </a>
            </div>
            <div class="main-sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            <span class="shape1"></span><span class="shape2"></span><i
                                class="fa fa-film  sidemenu-icon"></i><span class="sidemenu-label">ایجاد فیلم</span><i
                                class="angle fe fe-chevron-left"></i>
                        </a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('imdb.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('imdb.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            <span class="shape1"></span><span class="shape2"></span><i
                                class="fa fa-television   sidemenu-icon"></i><span class="sidemenu-label">ایجاد
                                سریال</span><i class="angle fe fe-chevron-left"></i>
                        </a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('serial.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('serial.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            <span class="shape1"></span><span class="shape2"></span><i
                                class="ti-user sidemenu-icon"></i><span class="sidemenu-label">کاربران</span><i
                                class="angle fe fe-chevron-left"></i>
                        </a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('user.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('user.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            <span class="shape1"></span><span class="shape2"></span><i
                                class="fa fa-money   sidemenu-icon"></i><span class="sidemenu-label">بسته های
                                فروش</span><i class="angle fe fe-chevron-left"></i>
                        </a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#">
                            <span class="shape1"></span><span class="shape2"></span><i
                                class="fa fa-bell   sidemenu-icon"></i><span class="sidemenu-label">ایجاد
                                اطلاعیه</span><i class="angle fe fe-chevron-left"></i>
                        </a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('notification.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('notification.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('vippack.index') }}"><span class="shape1"></span><span
                                class="shape2"></span><i class="fa fa-money fa-2x sidemenu-icon"></i><span
                                class="sidemenu-label">خرید بسته</span></a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="main-header-center">
                    <div class="responsive-logo text-center">
                        <a href="index.html"><img src="/assets/img/brand/logo.png" height="50px" class=""
                                alt="لوگو" /></a>
                    </div>
                </div>
                <div class="main-header-right">
                    ...
                    <div class="dropdown main-profile-menu">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item border-top" href="profile.html"> <i class="fe fe-user"></i>
                                پروفایل من </a>
                            <a class="dropdown-item" href="profile.html"> <i class="fe fe-edit"></i> ویرایش نمایه
                            </a>
                            <a class="dropdown-item" href="profile.html"> <i class="fe fe-settings"></i> تنظیمات حساب
                            </a>
                            <a class="dropdown-item" href="profile.html"> <i class="fe fe-settings"></i> پشتیبانی
                            </a>
                            <a class="dropdown-item" href="profile.html"> <i class="fe fe-compass"></i> فعالیت </a>
                            <a class="dropdown-item" href="signin.html"> <i class="fe fe-power"></i> خروج از سیستم
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex order-lg-2 mr-auto">
                        ...
                        <div class="dropdown main-profile-menu">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="profile.html"> <i class="fe fe-settings"></i> تنظیمات
                                    حساب </a>
                                <a class="dropdown-item" href="profile.html"> <i class="fe fe-settings"></i> پشتیبانی
                                </a>
                                <a class="dropdown-item" href="profile.html"> <i class="fe fe-compass"></i> فعالیت
                                </a>
                                <a class="dropdown-item" href="signin.html"> <i class="fe fe-power"></i> خروج از
                                    سیستم </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="main-footer text-center">
            <div class="container">
                <div class="row row-sm">
                    <div class="col-md-12">
                        <p> Copyright 2019 - All Rights Reserved by Ahura LLC </p>
                    </div>
                </div>
            </div>
        </div>
