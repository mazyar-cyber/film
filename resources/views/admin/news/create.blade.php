                ...
                <div class="card-header border-bottom-0 pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mr-auto float-right">
                            <a href="{{ route('news.index') }}" class="btn btn-info"> <i
                    ...
                    <form action="{{ route('news.store') }}" method="POST" class="my-5" enctype="multipart/form-data">
                        @csrf
                        <div class="d-flex row ">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">عنوان خبر </label>
                                ...
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">توضیحات</label>
