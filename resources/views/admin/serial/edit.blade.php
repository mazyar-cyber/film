                ...
                <div class="card-header border-bottom-0 pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mr-auto float-right">
                            <a href="{{ route('serial.index') }}" class="btn btn-info"> <i
                                    class="fa fa-arrow-right mx-2"></i>برگشت به
                                لیست</a>
                        </div>
                    </div>
                    <p class="tx-12 tx-gray-500 mt-0 mb-2">api / ویرایش سریال </p>
                    <div class="col-sm-12">
                    ...
                    <form method="post" action="{{ route('serial.update', $model->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex row ">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">نوع سریال را مشخص کنید </label>
                                    <select name="type" class="form-control">
                                        <option @if ($model->type == 'irani') selected @endif value="irani">ایرانی
                                        </option>
                                        <option @if ($model->type == 'korean') selected @endif value="korean">کره ای
                                        </option>
                                        <option @if (($model->type != 'irani') & ($model->type != 'korean')) selected @endif value="somethingElse">غیره
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">عنوان فارسی</label>

                                    <input type="text" class="form-control " placeholder="عنوان فارسی" name="Fa_title"
                                ...
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">عکس افقی </label>
                                    <input class="form-control" placeholder="لینک عکس را اینجا وارد کنید" type="text"
                                        name="hor_pic" value="{{ $model->photo_hor }}" />
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">آخرین آپدیت</label>
                                    <input class="form-control" type="text" value="{{ $model->lastUpdate }}"
                                        name="lastUpdate" required />
                                </div>
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">وضعیت پخش</label>
                                    <input class="form-control" type="text" value="{{ $model->playStatus }}"
                                        name="playStatus" required />
                                </div>

                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">کانال</label>
                                    <input class="form-control" type="text" value="{{ $model->channel }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ $model->director }}"
                                        placeholder="لطفا کارگردان ها را با '،' از هم جدا کنید" name="director"
                                        required />
                                </div>
