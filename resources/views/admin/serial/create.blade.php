            ...
            <div class="card custom-card">
                <div class="card-header border-bottom-0 pb-0">
                    <div class="d-flex justify-content-between">
                        <label class="main-content-label mb-0 pt-1">ایجاد سریال</label>
                    ...
                    <div class="col-sm-12">
                        ...
                        @endif
                        <form action="{{ route('send.api.serial') }}" method="post">
                            @csrf
                    ...
                    <hr>
                    <hr>
                    <form action="{{ route('serial.store') }}" method="POST" class="my-5"
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="somethingElse">غیره </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lastUpdate" required />
                                </div>
                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">وضعیت پخش</label>
                                    <input class="form-control" type="text" name="playStatus" required />
                                </div>

                                <div class="form-group">
                                    <label for="addres-article" class="addres-article my-2">کانال</label>
                                    <input class="form-control" type="text" name="channel" required />
                                </div>
