            ...
            <header class="bg-white mb-4">
                ...
                <nav class="navbar navbar-expand-lg justigy-content-between main-nav mx-3 rounded py-3 px-2">
                    <div class="navbar justify-content-between w-100 navbar-sm">
                        ...
                        <form class="form w-sm-25">
                            <div
                                class="form-control d-flex justify-content-center bg-transparent frm-sm align-items-center">
                                <input type="text" class="search-input bg-transparent" placeholder="جستجو ..." />
                ...
                <div class="row">
                    ...
                    <form action=""
                        ...
                        <div class="col-sm-3 col-6 form-group my-1 p-2">
                            ...
                            <select class="form-select bg-secondary-custom sl-control d-inline-block" name=""
                                id="">
                        ...
                        <div class="col-sm-3 col-12 form-group my-1 p-2">
                            ...
                            <select class="form-select bg-secondary-custom sl-control-year d-inline-block"
                                name="" id="">
                        ...
                        <div class="row days-of-week-box">
                            <div
                                ...
                                <span class="days d-inline-block btn-thursday py-2 px-4 border-radius-5rem">سه
                                    شنبه</span>
                                <span
                                    class="days d-inline-block btn-wendesday py-2 px-4 border-radius-5rem">چهارشنبه</span>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex w-50 px-2 flex-column">
                                            ...
                                            <div class="d-sm-flex  weekly-movie-date-rate justify-content-between">
                                                ...
                                                <div>
                                                    <span class="title-movie">Rating :</span><span
                                                        class="title-movie">7.6</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="weekly-img-box">
                                            <img src="frontAssest/images/movies-poster/the-flash.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!-- 2 -->
                ...
                <div class="row px-2">
                    <div class="col-sm-9 ml-3 col-12 pb-5">
                        <div class="row w-100 justify-content-between">
                            ...
                            <div
                                ...
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">Last</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">...</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">20</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">10</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">...</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">4</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">3</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">2</a>
                                <a href="#"
                                    class="d-inline-block border border-radius-5rem mx-1 movies-page-sm">1</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-12 d-flex">
                        <div class="row flex-column w-100">
                            ...
                            <!-- **********************Movies category*************************** -->
                            <div
                                class="col-12 mb-3 flex-grow-1 movies-category position-relative border-radius-5rem bg-white p-0">
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <span
                                            class="categories btn-movies-R d-inline-block py-2 border-radius-5rem">رده
                                            سنی</span>
                                        <span
                                            class="categories btn-movies-point d-inline-block py-2 border-radius-5rem">امتیاز</span>
                                        <span
                                            class="categories btn-movies-year d-inline-block py-2 border-radius-5rem">سال</span>
                                    </div>
                                </div>
                                ...
                                <div class="row movies-genre position-absolute bg-info w-80 m-auto py-2">
                                    <div class="col-6">
                                        <ul class="categories-menu">
                                            <li>
                                                <a href="#"
                                                    class="d-inline-block border-radius-5rem">اجتماعی</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    class="d-inline-block border-radius-5rem">انیمیشن</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="#"
                                                    class="d-inline-block border-radius-5rem">ترسناک</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-6">
                                        <ul class="categories-menu">
                                            ...
                                            <li>
                                                <a href="#"
                                                    class="d-inline-block border-radius-5rem">تاریخی</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    class="d-inline-block border-radius-5rem">جنایی</a>
                                            </li>
                                            <li>
                                                <a href="#" class="d-inline-block border-radius-5rem">اکشن</a>
                                            </li>
                            ...
                            <div
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <span
                                            class="categories btn-series-R d-inline-block py-2 border-radius-5rem">رده
                                            سنی</span>
                                        <span
                                            class="categories btn-series-point d-inline-block py-2 border-radius-5rem">امتیاز</span>
                                        <span
                                            class="categories btn-series-year d-inline-block py-2 border-radius-5rem">سال</span>
                                    </div>
                                </div>
                                <!-- categories content *** year *** -->
                            ...
                            <div class="col-12 flex-grow-1 border-radius-5rem bg-white p-0">
                                ...
                                <div class="asking-imgs-box m-auto d-flex">
                                    <!-- img 1 -->
                                    <a href="#" class="d-inline-block">
                                        <img src="frontAssest/images/movies-poster/asking-movie-1.jpg"
                                            class="img-fluid" alt="" />
                                    </a>
                                    <!-- img 2 -->
                                    <a href="#" class="d-inline-block">
                                        <img src="frontAssest/images/movies-poster/asking-movie-2.jpg"
                                            class="img-fluid" alt="" />
                                    </a>
                                    <!-- img 3 -->
                                    <a href="#" class="d-inline-block">
                                        <img src="frontAssest/images/movies-poster/asking-movie-3.jpg"
                                            class="img-fluid" alt="" />
                                    </a>
                                    <!-- img 4 -->
                                    <a href="#" class="d-inline-block">
                                        <img src="frontAssest/images/movies-poster/asking-movie-4.jpg"
                                            class="img-fluid" alt="" />
                                    </a>
                                    <!-- img 5 -->
                                    <a href="#" class="d-inline-block">
                                        <img src="frontAssest/images/movies-poster/asking-movie-5.jpg"
                                            class="img-fluid" alt="" />
                                    </a>
                                </div>
                    ...
                    <div class="last-news-main-content border-radius-5rem bg-white">
                        ...
                        <div class="col-sm-6 col-12 d-flex px-sm-5">
                            <div class="last-news-img-box">
                                <a href="#" class="d-inline-block">
                                    <img src="frontAssest/images/movies-poster/last-news-1.jpg"
                                        class="img-fluid p-2" alt="" />
                                </a>
                            </div>
                            <div class="last-news-content d-flex flex-column align-items-between p-3">
                                <h2>معرفی و بررسی انواع کیفیت فیلم ها</h2>
                                <p class="last-news-text">
                                    کیفیت بعدی (3D) : عبارت سه بعدی به تنهای مشخص کننده ی کیفیت فیلم
                                    نیست و بیانگر این است که فیلم را باید با نمایشگر های مخصوص و
                                    دارای تست تستس تستستست
                                </p>
                            </div>
                ...
                <div class="row">
                    <div class="footer-content w-80 m-auto d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="#" class="icon-btn"><img
                                        src="frontAssest/images/icons/Instagram.png" class="img-fluid"
                                        alt=""></a>
                                <a href="#" class="icon-btn"><img
                                        src="frontAssest/images/icons/telegram.png" class="img-fluid"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
